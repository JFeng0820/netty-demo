...
public class RedisUtil {
    ...
    public void pushObj(UserChannelInfo channelInfo) {
        redisTemplate.opsForHash().put("itstack-demo-netty-2-09-user", channelInfo.getChannelId(), JSON.toJSONString(channelInfo));
    }
